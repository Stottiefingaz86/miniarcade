            ...
            <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-2 px-6" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              ...
              {casinoGames.map((game) => {
                return (
                  <button
                    key={game.id}
                    className="relative w-32 h-40 rounded-lg overflow-hidden transition-all duration-200 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 group flex-shrink-0 shadow-sm hover:shadow-lg"
                    onClick={() => {
